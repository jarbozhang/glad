...
export const pl: TranslationStructure = {
    ...
    components: {
        emptyMainScreen: {
            ...
            connectCli: 'Połącz Happy CLI',
            installCli: 'Zainstaluj Happy CLI',
            runIt: 'Uruchom je',
            runCliAuth: 'Uruchom happy auth login lub happy',
            scanQrCode: 'Zeskanuj kod QR',
            pasteTerminalUrl: 'Wklej URL z terminala',
    ...
    contextPanel: {
        noSession: 'Otwórz sesję, aby przeglądać pliki',
        searchPlaceholder: 'Szukaj plików...',
        upload: 'Prześlij',
        uploadToCurrentDirectory: 'Prześlij do bieżącego katalogu',
        dropFilesToUpload: 'Upuść pliki, aby je przesłać',
