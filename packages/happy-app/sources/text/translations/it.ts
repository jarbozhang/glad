...
export const it: TranslationStructure = {
    ...
    components: {
        emptyMainScreen: {
            ...
            connectCli: 'Collega la CLI Happy',
            installCli: 'Installa la CLI Happy',
            runIt: 'Avviala',
            runCliAuth: 'Esegui happy auth login o happy',
            scanQrCode: 'Scansiona il codice QR',
            pasteTerminalUrl: 'Incolla l\'URL del terminale',
    ...
    contextPanel: {
        noSession: 'Apri una sessione per sfogliare i file',
        searchPlaceholder: 'Cerca file...',
        upload: 'Carica',
        uploadToCurrentDirectory: 'Carica nella directory corrente',
